import {
  ...
  SAVE_DISPUTED_CAMPAIGNS,
  ON_ERROR_DISPUTED_CAMPAIGNS,
  USER_DETAILS,
  CREATE_WALLET, SAVE_INFLUENCER_DATA
} from "./contant"
...
export const postCreateWallet = (email) => {
  return {
    type: CREATE_WALLET,
    email
  }
...
export const saveInfluencerDataAction = (user) => {
  return {
    type: SAVE_INFLUENCER_DATA,
    user
  }
}
