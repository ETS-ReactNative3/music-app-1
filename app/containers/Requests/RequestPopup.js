...
const RequestPopup = (
  ...
  return (
    <div style={styles.container}>
            ...
            <div style={styles.selectedSongParent}>
              ...
              <div style={{display: 'flex', flexDirection: 'column'}}>
                <Button
                  ...
                  variant="success"
                  onClick={() => listenToSong(data.campaigns.song)}>Click to play</Button>
      ...
      <div
        style={(feedbackProvided || data.feedback !== null) ? styles.section : {...styles.section, ...styles.blurStyle}}>
        <h4>Share :</h4>
        <fieldset disabled={!(feedbackProvided || data.feedback !== null)}>
          <div style={{display: 'flex', flexDirection: 'column', alignItems: 'flex-start'}}>
            ...
            {!(data.campaignStatusId === CampaignStatus.COMPLETED || data.campaignStatusId === CampaignStatus.APPROVED) &&
                ...
                <div style={{display: 'flex', flexWrap: 'wrap', flex: 1}}>
                  ...
                  <div style={{width: '50%'}}>
                    <div style={styles.socialMediaItem}>
                      ...
                      <input
                        ref={register}
                        name="facebook" className="input-url" id="endereco" type="text" placeholder="Enter Facebook url"
                        required/>
                      <div
                  ...
                  <div style={{width: '50%'}}>
                    ...
                    <div style={styles.socialMediaItem}>
                      ...
                      <input
                        ref={register}
                        name="instagram" className="input-url" id="endereco" type="text"
                  ...
                  <div style={{width: '50%'}}>
                    <div style={styles.socialMediaItem}>
                      ...
                      <input
                        ref={register}
                        name="twitter" className="input-url" id="endereco" type="text" placeholder="Enter Twitter url"
                        required/>
                  ...
                  <div style={{width: '50%'}}>
                    ...
                    <div style={styles.socialMediaItem}>
                      ...
                      <input
                        ref={register}
                        name="blog" className="input-url" id="endereco" type="text" placeholder="Enter Blog url"
                        required/>
                      <div
                        className="invalid-feedback" style={{display: 'block'}}>
                  ...
                  <div style={{width: '50%'}}>
                    ...
                    <div style={{...styles.socialMediaItem, ...{width: '50%'}}}>
                      ...
                      <input
                        ref={register}
                        name="youtube" className="input-url" id="endereco" type="text" placeholder="Enter Youtube url"
                        required/>
                      <div
                        className="invalid-feedback" style={{display: 'block'}}>
            ...
            || <div>
              {data.campaignInfluencerServices.findIndex(service => service.socialChannelsId === SOCIAL_CHANNELS.FACEBOOK) !== -1 &&
              <div> Facebook: <Link
                to={`${data.campaignInfluencerServices.find(service => service.socialChannelsId === SOCIAL_CHANNELS.FACEBOOK).response}`}>{data.campaignInfluencerServices.find(service => service.socialChannelsId === SOCIAL_CHANNELS.FACEBOOK).response}</Link>
              </div>}

              {data.campaignInfluencerServices.findIndex(service => service.socialChannelsId === SOCIAL_CHANNELS.INSTAGRAM) !== -1 &&
              <div> Instagram: <Link
                to={`${data.campaignInfluencerServices.find(service => service.socialChannelsId === SOCIAL_CHANNELS.INSTAGRAM).response}`}>{data.campaignInfluencerServices.find(service => service.socialChannelsId === SOCIAL_CHANNELS.INSTAGRAM).response}</Link>
              </div>}

              {data.campaignInfluencerServices.findIndex(service => service.socialChannelsId === SOCIAL_CHANNELS.TWITTER) !== -1 &&
              <div> Twitter: <Link
                to={`${data.campaignInfluencerServices.find(service => service.socialChannelsId === SOCIAL_CHANNELS.TWITTER).response}`}>{data.campaignInfluencerServices.find(service => service.socialChannelsId === SOCIAL_CHANNELS.TWITTER).response}</Link>
              </div>}

              {data.campaignInfluencerServices.findIndex(service => service.socialChannelsId === SOCIAL_CHANNELS.BLOG) !== -1 &&
              <div> Blog: <Link
                to={`${data.campaignInfluencerServices.find(service => service.socialChannelsId === SOCIAL_CHANNELS.BLOG).response}`}>{data.campaignInfluencerServices.find(service => service.socialChannelsId === SOCIAL_CHANNELS.BLOG).response}</Link>
              </div>}

              {data.campaignInfluencerServices.findIndex(service => service.socialChannelsId === SOCIAL_CHANNELS.YOUTUBE) !== -1 &&
              <div> Youtube: <Link
                to={`${data.campaignInfluencerServices.find(service => service.socialChannelsId === SOCIAL_CHANNELS.YOUTUBE).response}`}>{data.campaignInfluencerServices.find(service => service.socialChannelsId === SOCIAL_CHANNELS.YOUTUBE).response}</Link>
              </div>}
            </div>}
