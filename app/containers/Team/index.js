      ...
      {progress ? <LoadingIndicator/> :
        <PaperCard title="My Teams">
          <div className="row mb-3">
            <div className="col">
              <Button className="mr-2" variant="success" onClick={() => history.push('/team/add')}>Add Team</Button>
              <Button className="mr-2" variant="success" onClick={() => history.push('/team/request')}>Team
                Request</Button>
              <Button className="mr-2" variant="success" onClick={() => history.push('/myteams')}>My
