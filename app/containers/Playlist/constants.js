...
export const DELETE_SONG_PLAYLIST_REQUEST = 'app/Playlist/DELETE_SONG_PLAYLIST_REQUEST';
export const DELETE_SONG_PLAYLIST_SUCCESS = 'app/Playlist/DELETE_SONG_PLAYLIST_SUCCESS';
export const DELETE_SONG_PLAYLIST_FAIL = 'app/Playlist/DELETE_SONG_PLAYLIST_FAIL';

export const ADD_SONG_INTO_PAYLIST = 'app/Playlist/ADD_SONG_INTO_PAYLIST';
export const ADD_SONG_INTO_PAYLIST_SUCCESS = 'app/Playlist/ADD_SONG_INTO_PAYLIST_SUCCESS';
export const ADD_SONG_INTO_PAYLIST_FAIL = 'app/Playlist/ADD_SONG_INTO_PAYLIST_FAIL';

export const CREATE_PLAYLIST_AND_ADD_SONG = 'app/Playlist/CREATE_PLAYLIST_AND_ADD_SONG';
export const CREATE_PLAYLIST_AND_ADD_SONG_SUCCESS = 'app/Playlist/CREATE_PLAYLIST_AND_ADD_SONG_SUCCESS';
export const CREATE_PLAYLIST_AND_ADD_SONG_FAIL = 'app/Playlist/CREATE_PLAYLIST_AND_ADD_SONG_FAIL';
